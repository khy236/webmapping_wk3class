...
map.on('load', () => {
    ...
    map.on('click', 'unclustered-point', (e) => {
        ...
        const created = new Date(e.features[0].properties.created_date);
        var closed = e.features[0].properties.closed_date;

        if (closed === undefined) {
            closed = "N/A";
        } else {
            closed = new Date(e.features[0].properties.closed_date);
        }
